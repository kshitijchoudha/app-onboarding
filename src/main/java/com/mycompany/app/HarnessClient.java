...
public class HarnessClient {
  ...
  public String createHarnessService(String serviceName, String gitHubRepoName)
      throws IOException, InterruptedException {
    var httpClient = HttpClient.newBuilder().build();
  ...
  public String createHarnessPipeline(String pipelineName, String serviceId, String environmentId, String infraDefId,
